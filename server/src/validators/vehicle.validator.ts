...
export const addVehicleSchema = Joi.object({
  brand_id: Joi.number().strict().required().messages({
  ...
  first_registration: Joi.date().required().messages({
  ...
  .messages({
    "object.unknown":
      "Seuls les champs 'brand_id', 'model', 'color_id', 'energy_id', 'seats', 'license_plate', 'first_registration' sont autorisés.",
  });
...
export const updateVehicleSchema = Joi.object({
  brand_id: Joi.number().strict().optional().messages({
    "number.base": "L'id de la marque doit être un nombre.",
  }),
  ...
  color_id: Joi.number().strict().optional().messages({
    "number.base": "L'id de la couleur doit être un nombre.",
  }),
  energy_id: Joi.number().strict().optional().messages({
    "number.base": "L'id de l'énergie doit être un nombre.",
  }),
  ...
  .messages({
    "object.unknown":
      "Seuls les champs 'brand_id', 'model', 'color_id', 'energy_id', 'seats' sont autorisés.",
  });
