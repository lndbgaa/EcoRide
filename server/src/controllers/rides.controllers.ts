 ...
 */
export const searchForRides = catchAsync(
  async (req: Request, res: Response): Promise<void> => {
    const userId = req.user?.id;
    const data = req.body;
 ...
 */
export const getRideDetails = catchAsync(
  async (req: Request, res: Response): Promise<void> => {
 ...
 */
export const startRide = catchAsync(
  async (req: Request, res: Response): Promise<void> => {
    const userId = req.user.id;
    const rideId = req.params.id;
    ...
    res
      .status(200)
      .json({ success: true, message: "Trajet démarré avec succès." });
  }
);
 ...
 */
export const endRide = catchAsync(
  async (req: Request, res: Response): Promise<void> => {
    const userId = req.user.id;
    const rideId = req.params.id;
    ...
    res
      .status(200)
      .json({ success: true, message: "Trajet terminé avec succès." });
  }
);
...
export const cancelRide = catchAsync(
  async (req: Request, res: Response): Promise<void> => {
    ...
    res
      .status(200)
      .json({ success: true, message: "Trajet annulé avec succès." });
  }
);
