 ...
 */
export const addPreference = catchAsync(async (req: Request, res: Response): Promise<void> => {
 ...
 */
export const updatePreference = catchAsync(async (req: Request, res: Response): Promise<void> => {
  const userId = req.user.id;
  const preferenceId = req.params.id;

  const updatedPreference = await PreferenceService.togglePreferenceValue(userId, preferenceId);
 ...
 */
export const deletePreference = catchAsync(async (req: Request, res: Response): Promise<void> => {
  const userId = req.user.id;
  const preferenceId = req.params.id;
