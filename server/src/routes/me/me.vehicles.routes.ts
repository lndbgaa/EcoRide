...
import { createMyVehicle, deleteMyVehicle, getMyVehicle, getMyVehicles, updateMyVehicle } from "@/controllers";
...
router.patch("/:id", validateAll(idParamSchema, "params"), validateAll(updateVehicleBodySchema), updateMyVehicle);
