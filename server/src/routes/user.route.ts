...
import { addVehicle, deleteVehicle, getMyVehicles, updateVehicle } from "@/controllers/vehicle.controller.js";
...
router.patch("/me/vehicles/:id", validate(idParamSchema, "params"), validate(updateVehicleSchema), updateVehicle);
...
router.get("/me/events/next", getUserNextEvent); // Prochain événement à venir (réservation, trajet)
router.get("/me/events/upcoming", getUserUpcomingEvents); // Tous les événements à venir (réservation, trajet)
