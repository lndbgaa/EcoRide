...
import styles from "./ResolvedIncidentsPage.module.css";

import type { IncidentPreview } from "@/types/IncidentTypes";

const NewIncidentsPage = () => {
  ...
  const fetchIncidents = async () => {
    ...
    try {
      const response = await EmployeeService.getResolvedIncidents();
      ...
      <div className={styles.incidentsList}>
        {incidents.length === 0 ? (
          <div className={styles.noIncidentsContainer}>
            ...
            <p>Vous n'avez pas encore résolu d'incident.</p>
          </div>
        ) : (
